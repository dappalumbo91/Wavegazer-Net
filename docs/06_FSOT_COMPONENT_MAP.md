...
| Next-frame edges (CellMot transformer+ILP) | Same cell at t and t+1 | Bleed κ on centroids: ident `1/(1+\|ΔS\|/Θ)`, spat `1/(1+d/σ)`, search `φ·7` µm. Zero weights. | Quantum `κ_ij`; GPU collapse Θ; Fluid_Dynamics skip fold |
